...
// Getting data from the booking form 
 $date =  $_SESSION['date'];
 $time =    $_SESSION['time']; 
...
$spaceCusID = $_SESSION['customerID'];
...
$amount = $hours * 2;
// Inserting the booking in the booking tabel
$sql1 = "INSERT INTO booking(hours, ownerID, amount, spaceaddress, spacepostcode, owneremail, ownerphone, driverID, spaceType, date, time, customerID, paidOnline) VALUES ('$hours', '$sID', '$amount','$address', '$postcode', '$email', '$phone', $cusID, '$spaceType','$date','$time', '$spaceCusID', 'Yes' )";
...
<link href="https://fonts.googleapis.com/css2?family=Alkatra&family=PT+Serif&family=Quicksand:wght@300&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <div style="text-align:center; text-decoration: underline"><h4>Payment Confirmed</h4></div>
        <div style="text-align: center">
        <img src="images/success.png" alt="confirmed" style="width: 300px; height: 200px; border-radius: 10px;">
        </div>
        
        <div style = "padding: 10px; margin-top:50px; margin-bottom:20px; height: 250px" >
  ...
  echo "Booking ID: " . $last_id.   ",  Address: " . $address. ", Postcode: " . $postcode. ", Space Type: ". $spaceType. ", Date:". $date . ", Time: " . $time . "<br>"; ?>
           ...
           <?php echo "Phone: " . $phone.   ",  Email: " . $email.  "<br>"; ?>
             ...
             <div style="text-align: center; margin-top: 30px"><button style = "font-size: 16px;  padding: 5px 10px; border-radius: 5px; background-color: #46E14E; border: 1px solid  #46E14E; width: 150px"><a style="color:white; text-decoration:none;" href="users.php"><i class="fa-solid fa-arrow-left"></i>Back</a></button>
                   </div>
